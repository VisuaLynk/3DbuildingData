...
// VERI TRANSFERI VE 3 BOYUTLU MODELLEME OZELLIKLERI ICIN 3Dbuilding_Graph.js VE 3Dbuilding.js DOSYALARINA BAKINIZ.

visualynk = function() {
    var a = {
        start: function(b) {
            a.logger.info("visualynk " + a.version + " start.");
            "undefined" == typeof a.rest.CYPHER_URL ? a.logger.error("visualynk.rest.CYPHER_URL is not set, but required.") : (a.checkHtmlComponents(), a.taxonomy.isActive && a.taxonomy.createTaxonomyPanel(), a.graph.isActive && (a.graph.createGraphArea(), a.graph.createForceLayout(), a.graph.addRootNode(b)), a.queryviewer.isActive && a.queryviewer.createQueryArea(), a.update())
        },
    ...
    a.taxonomy.createTaxonomyPanel = function() {
        ...
        b.append("img").attr("src", "img/category.png").attr("width", "24").attr("height", "24");
    ...
    a.taxonomy.addTaxonomyChildren = function(b) {
        b.each(function(b) {
            ...
            b.children && (b = d.append("ul").selectAll("li").data(e).enter().append("li").attr("id", function(a) {
                ...
                return a.label
            }), b.append("img").attr("src", "img/category.png").attr("width",
                "24").attr("height", "24"), b.append("span").attr("class", "vslynk-label").text(function(b) {
                return a.provider.getTaxonomyTextValue(b.label)
            }), b.append("span").attr("class", "vslynk-count"), b.on("click", a.taxonomy.onClick), a.taxonomy.addTaxonomyChildren(b))
        })
    };
    ...
    a.taxonomy.generateTaxonomiesData = function() {
        ...
        c.forEach(function(c) {
            a.provider.getProvider(c.label).hasOwnProperty("children") && (b = a.taxonomy.addChildrenData(c,
                b))
        });
        return c
    };
    ...
    a.queryviewer.updateQuery = function() {
        ...
        a.queryviewer.querySpanElements = a.queryviewer.querySpanElements.data([]);
        a.queryviewer.queryConstraintSpanElements.exit().remove();
        a.queryviewer.querySpanElements.exit().remove();
        a.queryviewer.queryConstraintSpanElements = a.queryviewer.queryConstraintSpanElements.data(a.queryviewer.generateConstraintData(a.graph.force.links(),
            a.graph.force.nodes()));
        ...
        a.queryviewer.queryConstraintSpanElements.enter().append("span").on("contextmenu", a.queryviewer.rightClickSpan).on("click", a.queryviewer.clickSpan).on("mouseover", a.queryviewer.mouseOverSpan).on("mouseout", a.queryviewer.mouseOutSpan);
        a.queryviewer.querySpanElements.enter().append("span").on("contextmenu", a.queryviewer.rightClickSpan).on("click",
            a.queryviewer.clickSpan).on("mouseover", a.queryviewer.mouseOverSpan).on("mouseout", a.queryviewer.mouseOutSpan);
        a.queryviewer.queryConstraintSpanElements.attr("id", function(a) {
            return a.id
        }).attr("class", function(b) {
            return b.isLink ? "vslynk-span-link" : b.type === a.graph.node.NodeTypes.ROOT ? "vslynk-span-root" : b.type === a.graph.node.NodeTypes.CHOOSE ? b.ref.value ? "vslynk-span-value" : "vslynk-span-choose" : b.type === a.graph.node.NodeTypes.VALUE ? "vslynk-span-value" : b.type === a.graph.node.NodeTypes.GROUP ? "vslynk-span-group" : "vslynk-span"
        }).text(function(a) {
            return a.term +
                " "
        });
    ...
    a.provider.DEFAULT_PROVIDER = Object.freeze({
        ...
        getSemanticValue: function(b) {
            var c = a.provider.getProperty(b.label, "URLlinkAttribute");
